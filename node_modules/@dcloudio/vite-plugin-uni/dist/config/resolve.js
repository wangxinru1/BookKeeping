...
const customResolver = (updatedId, importer) => {
    ...
    const utsModuleFile = process.env.UNI_PLATFORM === 'app'
        ? (0, uni_cli_shared_1.resolveUtsModuleProxyFile)(updatedId, utsImporter)
        : (0, uni_cli_shared_1.resolveUtsModule)(updatedId, utsImporter, process.env.UNI_UTS_PLATFORM);
    if (utsModuleFile) {
